...
pub fn create_lookup_table() -> [Instruction; 256] {
    ...
    [
        ...
        I(O::NOP, A::ABS),I(O::ORA, A::ABS),I(O::ASL, A::ABS),I(O::XXX, A::ABS),
        I(O::BPL, A::REL),I(O::ORA, A::IDY),I(O::XXX, A::REL),I(O::XXX, A::IDY),
        I(O::NOP, A::ZPX),I(O::ORA, A::ZPX),I(O::ASL, A::ZPX),I(O::XXX, A::ZPX),
        I(O::CLC, A::IMP),I(O::ORA, A::ABY),I(O::NOP, A::IMP),I(O::XXX, A::ABY),
        I(O::NOP, A::ABX),I(O::ORA, A::ABX),I(O::ASL, A::ABX),I(O::XXX, A::ABX),

        I(O::JSR, A::ABS),I(O::AND, A::IDX),I(O::XXX, A::IMP),I(O::XXX, A::IDX),
        I(O::BIT, A::ZP0),I(O::AND, A::ZP0),I(O::ROL, A::ZP0),I(O::XXX, A::ZP0),
        I(O::PLP, A::IMP),I(O::AND, A::IMM),I(O::ROL, A::ACC),I(O::XXX, A::IMM),
        I(O::BIT, A::ABS),I(O::AND, A::ABS),I(O::ROL, A::ABS),I(O::XXX, A::ABS),
        I(O::BMI, A::REL),I(O::AND, A::IDY),I(O::XXX, A::REL),I(O::XXX, A::IDY),
        I(O::NOP, A::ZPX),I(O::AND, A::ZPX),I(O::ROL, A::ZPX),I(O::XXX, A::ZPX),
        I(O::SEC, A::IMP),I(O::AND, A::ABY),I(O::NOP, A::IMP),I(O::XXX, A::ABY),
        I(O::NOP, A::ABX),I(O::AND, A::ABX),I(O::ROL, A::ABX),I(O::XXX, A::ABX),

        I(O::RTI, A::IMP),I(O::EOR, A::IDX),I(O::XXX, A::IMP),I(O::XXX, A::IDX),
        I(O::NOP, A::ZP0),I(O::EOR, A::ZP0),I(O::LSR, A::ZP0),I(O::XXX, A::ZP0),
        I(O::PHA, A::IMP),I(O::EOR, A::IMM),I(O::LSR, A::ACC),I(O::XXX, A::IMM),
        I(O::JMP, A::ABS),I(O::EOR, A::ABS),I(O::LSR, A::ABS),I(O::XXX, A::ABS),
        I(O::BVC, A::REL),I(O::EOR, A::IDY),I(O::XXX, A::REL),I(O::XXX, A::IDY),
        I(O::NOP, A::ZPX),I(O::EOR, A::ZPX),I(O::LSR, A::ZPX),I(O::XXX, A::ZPX),
        I(O::CLI, A::IMP),I(O::EOR, A::ABY),I(O::NOP, A::IMP),I(O::XXX, A::ABY),
        I(O::NOP, A::ABX),I(O::EOR, A::ABX),I(O::LSR, A::ABX),I(O::XXX, A::ABX),

        I(O::RTS, A::IMP),I(O::ADC, A::IDX),I(O::XXX, A::IMP),I(O::XXX, A::IDX),
        I(O::NOP, A::ZP0),I(O::ADC, A::ZP0),I(O::ROR, A::ZP0),I(O::XXX, A::ZP0),
        I(O::PLA, A::IMP),I(O::ADC, A::IMM),I(O::ROR, A::ACC),I(O::XXX, A::IMM),
        I(O::JMP, A::IND),I(O::ADC, A::ABS),I(O::ROR, A::ABS),I(O::XXX, A::ABS),
        I(O::BVS, A::REL),I(O::ADC, A::IDY),I(O::XXX, A::REL),I(O::XXX, A::IDY),
        I(O::NOP, A::ZPX),I(O::ADC, A::ZPX),I(O::ROR, A::ZPX),I(O::XXX, A::ZPX),
        I(O::SEI, A::IMP),I(O::ADC, A::ABY),I(O::NOP, A::IMP),I(O::XXX, A::ABY),
        I(O::NOP, A::ABX),I(O::ADC, A::ABX),I(O::ROR, A::ABX),I(O::XXX, A::ABX),

        I(O::NOP, A::IMM),I(O::STA, A::IDX),I(O::NOP, A::IMM),I(O::XXX, A::IDX),
        I(O::STY, A::ZP0),I(O::STA, A::ZP0),I(O::STX, A::ZP0),I(O::XXX, A::ZP0),
        I(O::DEY, A::IMP),I(O::NOP, A::IMM),I(O::TXA, A::IMP),I(O::XXX, A::IMM),
        I(O::STY, A::ABS),I(O::STA, A::ABS),I(O::STX, A::ABS),I(O::XXX, A::ABS),
        I(O::BCC, A::REL),I(O::STA, A::IDY),I(O::XXX, A::REL),I(O::XXX, A::IDY),
        I(O::STY, A::ZPX),I(O::STA, A::ZPX),I(O::STX, A::ZPY),I(O::XXX, A::ZPY),
        I(O::TYA, A::IMP),I(O::STA, A::ABY),I(O::TXS, A::IMP),I(O::XXX, A::ABY),
        I(O::NOP, A::ABX),I(O::STA, A::ABX),I(O::XXX, A::ABY),I(O::XXX, A::ABY),

        I(O::LDY, A::IMM),I(O::LDA, A::IDX),I(O::LDX, A::IMM),I(O::XXX, A::IDX),
        I(O::LDY, A::ZP0),I(O::LDA, A::ZP0),I(O::LDX, A::ZP0),I(O::XXX, A::ZP0),
        I(O::TAY, A::IMP),I(O::LDA, A::IMM),I(O::TAX, A::IMP),I(O::XXX, A::IMM),
        I(O::LDY, A::ABS),I(O::LDA, A::ABS),I(O::LDX, A::ABS),I(O::XXX, A::ABS),
        I(O::BCS, A::REL),I(O::LDA, A::IDY),I(O::XXX, A::REL),I(O::XXX, A::IDY),
        I(O::LDY, A::ZPX),I(O::LDA, A::ZPX),I(O::LDX, A::ZPY),I(O::XXX, A::ZPY),
        I(O::CLV, A::IMP),I(O::LDA, A::ABY),I(O::TSX, A::IMP),I(O::XXX, A::ABY),
        I(O::LDY, A::ABX),I(O::LDA, A::ABX),I(O::LDX, A::ABY),I(O::XXX, A::ABY),

        I(O::CPY, A::IMM),I(O::CMP, A::IDX),I(O::NOP, A::IMM),I(O::XXX, A::IDX),
        I(O::CPY, A::ZP0),I(O::CMP, A::ZP0),I(O::DEC, A::ZP0),I(O::XXX, A::ZP0),
        I(O::INY, A::IMP),I(O::CMP, A::IMM),I(O::DEX, A::IMP),I(O::XXX, A::IMM),
        I(O::CPY, A::ABS),I(O::CMP, A::ABS),I(O::DEC, A::ABS),I(O::XXX, A::ABS),
        I(O::BNE, A::REL),I(O::CMP, A::IDY),I(O::XXX, A::REL),I(O::XXX, A::IDY),
        I(O::NOP, A::ZPX),I(O::CMP, A::ZPX),I(O::DEC, A::ZPX),I(O::XXX, A::ZPX),
        I(O::CLD, A::IMP),I(O::CMP, A::ABY),I(O::NOP, A::IMP),I(O::XXX, A::ABY),
        I(O::NOP, A::ABX),I(O::CMP, A::ABX),I(O::DEC, A::ABX),I(O::XXX, A::ABX),

        I(O::CPX, A::IMM),I(O::SBC, A::IDX),I(O::NOP, A::IMM),I(O::XXX, A::IDX),
        I(O::CPX, A::ZP0),I(O::SBC, A::ZP0),I(O::INC, A::ZP0),I(O::XXX, A::ZP0),
        I(O::INX, A::IMP),I(O::SBC, A::IMM),I(O::NOP, A::IMP),I(O::SBC, A::IMM),
        I(O::CPX, A::ABS),I(O::SBC, A::ABS),I(O::INC, A::ABS),I(O::XXX, A::ABS),
        I(O::BEQ, A::REL),I(O::SBC, A::IDY),I(O::XXX, A::REL),I(O::XXX, A::IDY),
